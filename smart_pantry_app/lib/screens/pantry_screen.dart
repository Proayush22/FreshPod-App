        ...
        child: SizedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              FilterChip(
                  label: const Text('Expiring Soon'), onSelected: (bool selected) {}),
              const SizedBox(width: 8),
              FilterChip(label: const Text('Produce'), onSelected: (bool selected) {}),
              const SizedBox(width: 8),
              FilterChip(label: const Text('Dairy'), onSelected: (bool selected) {}),
              const SizedBox(width: 8),
              FilterChip(label: const Text('Grains'), onSelected: (bool selected) {}),
              const SizedBox(width: 8),
              FilterChip(label: const Text('Meats'), onSelected: (bool selected) {}),
              const SizedBox(width: 16),
            ],
          ),
        ),
